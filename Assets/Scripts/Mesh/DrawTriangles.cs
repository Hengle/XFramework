...
namespace XDEDZL.Mesh
{
    ...
    public class DrawTriangles
    {
        ...
        public static int DrawWithPointsDifferent(Vector3[] positions, float height, MeshFilter meshFilter, MeshRenderer meshRenderer, Material material_1)
        {
            ...
            //mesh.SetTriangles(Singleton<PhycisMath>.GetInstance().GetRangeArray(mesh.triangles, mesh.triangles.Length - differentM, mesh.triangles.Length - differentM + 5), 1);
            //mesh.SetTriangles(Singleton<PhycisMath>.GetInstance().GetRangeArray(mesh.triangles, mesh.triangles.Length - differentM + 6, mesh.triangles.Length - 1), 2);
