...
namespace XDEDZL.UI
{
    ...
    public class Draggable : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        public void Start()
        {
            ...
            Top = parentRect.position.y + parentRect.rect.size.y * (1 - pivot.y);
            Bottom = parentRect.position.y - parentRect.rect.size.y * pivot.y;
            Left = parentRect.position.x - parentRect.rect.size.x * pivot.x;
            Right = parentRect.position.x + parentRect.rect.size.x * (1 - pivot.x);
        }
